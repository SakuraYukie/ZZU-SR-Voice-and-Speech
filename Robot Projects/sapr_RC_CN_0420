...
void txtwrite(string str){
	fstream dataFile;
	dataFile.open("//home//robot//catkin_ws//src//sapr//src//result//theSpeechResult.txt", ios::app);
	cout<< str <<endl;
	if(!dataFile){
...
void kinect_detect_face()
{
    ...
    //~ //imshow("done", img);
    //~ imwrite("//home//robot//catkin_ws//src//sapr//src//result//thePersonRecogImg.jpg",img);
